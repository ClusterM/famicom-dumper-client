...
- **--bad-sectors** - comma separated list of bad sectors for COOLBOY/COOLGIRL writing
- **--sound** - play sound when done or error occured
- **--verify** - verify COOLBOY/COOLGIRL checksum after writing
...
~~~~
>FamicomDumper.exe dump --port COM14 --mapper mappers\coolboy.cs --prg-size 32M --file coolboy.unf --unif-name "COOLBOY 400-IN-1" --unif-author "John Smith"
Dumper initialization... OK
