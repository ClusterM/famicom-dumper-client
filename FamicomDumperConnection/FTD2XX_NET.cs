...
namespace FTD2XX_NET
{
    ...
    public class FTDI
    {
        ...
        public FTDI()
        {
            ...
            if (hFTD2XXDLL == IntPtr.Zero)
            {
                ...
                if (hFTD2XXDLL == IntPtr.Zero)
                {
                    ...
                    //throw new IOException("Attempting to load FTD2XX.DLL from:\n" + Path.GetDirectoryName(GetType().Assembly.Location));
            ...
            else
            {
                ...
                throw new IOException("Failed to load FTD2XX.DLL.  Are the FTDI drivers installed?");
            }
        }
        ...
        public FT_STATUS GetNumberOfDevices(ref UInt32 devcount)
        {
            ...
            {
                throw new IOException("Failed to load function FT_CreateDeviceInfoList.");
            }
            return ftStatus;
        ...
        public FT_STATUS GetDeviceList(FT_DEVICE_INFO_NODE[] devicelist)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_GetDeviceInfoListDetail.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS OpenByIndex(UInt32 index)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_Open.");
                }
                if (pFT_SetDataCharacteristics == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetDataCharacteristics.");
                }
                if (pFT_SetFlowControl == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetFlowControl.");
                }
                if (pFT_SetBaudRate == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetBaudRate.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS OpenBySerialNumber(string serialnumber)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_OpenEx.");
                }
                if (pFT_SetDataCharacteristics == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetDataCharacteristics.");
        ...
        public FT_STATUS Close()
        {
            ...
            else
            {
                if (pFT_Close == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Close.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS Read(byte[] dataBuffer, UInt32 numBytesToRead, ref UInt32 numBytesRead)
        {
            ...
            else
            {
                if (pFT_Read == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Read.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS Write(byte[] dataBuffer, Int32 numBytesToWrite, ref UInt32 numBytesWritten)
        {
            ...
            else
            {
                if (pFT_Write == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Write.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS ResetDevice()
        {
            ...
            else
            {
                if (pFT_ResetDevice == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_ResetDevice.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS Purge(UInt32 purgemask)
        {
            ...
            else
            {
                if (pFT_Purge == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Purge.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetEventNotification(UInt32 eventmask, EventWaitHandle eventhandle)
        {
            ...
            else
            {
                if (pFT_SetEventNotification == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetEventNotification.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS StopInTask()
        {
            ...
            else
            {
                if (pFT_StopInTask == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_StopInTask.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS RestartInTask()
        {
            ...
            else
            {
                if (pFT_RestartInTask == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_RestartInTask.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS ResetPort()
        {
            ...
            else
            {
                if (pFT_ResetPort == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_ResetPort.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS CyclePort()
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_CyclePort.");
                }
                if (pFT_Close == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Close.");
        ...
        public FT_STATUS Rescan()
        {
            ...
            else
            {
                if (pFT_Rescan == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Rescan.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS Reload(UInt16 VendorID, UInt16 ProductID)
        {
            ...
            else
            {
                if (pFT_Reload == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_Reload.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetBitMode(byte Mask, byte BitMode)
        {
            ...
            else
            {
                if (pFT_SetBitMode == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetBitMode.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetPinStates(ref byte BitMode)
        {
            ...
            else
            {
                if (pFT_GetBitMode == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetBitMode.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS ReadEEPROMLocation(UInt32 Address, ref UInt16 EEValue)
        {
            ...
            else
            {
                if (pFT_ReadEE == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_ReadEE.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS WriteEEPROMLocation(UInt32 Address, UInt16 EEValue)
        {
            ...
            else
            {
                if (pFT_WriteEE == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_WriteEE.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS EraseEEPROM()
        {
            ...
            else
            {
                if (pFT_EraseEE == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_EraseEE.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS ReadFT232BEEPROM(FT232B_EEPROM_STRUCTURE ee232b)
        {
            ...
            else
            {
                if (pFT_EE_Read == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_EE_Read.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS WriteFT232BEEPROM(FT232B_EEPROM_STRUCTURE ee232b)
        {
            ...
            else
            {
                if (pFT_EE_Program == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_EE_Program.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS EEReadUserArea(byte[] UserAreaDataBuffer, ref UInt32 numBytesRead)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_EE_UASize.");
                }
                if (pFT_EE_UARead == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_EE_UARead.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS EEWriteUserArea(byte[] UserAreaDataBuffer)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_EE_UAWrite.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetDeviceType(ref FT_DEVICE DeviceType)
        {
            ...
            else
            {
                if (pFT_GetDeviceInfo == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetDeviceInfo.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetRxBytesAvailable(ref UInt32 RxQueue)
        {
            ...
            else
            {
                if (pFT_GetQueueStatus == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetQueueStatus.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetTxBytesWaiting(ref UInt32 TxQueue)
        {
            ...
            else
            {
                if (pFT_GetStatus == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetStatus.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetModemStatus(ref byte ModemStatus)
        {
            ...
            else
            {
                if (pFT_GetModemStatus == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetModemStatus.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetRTS(bool Enable)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_SetRts.");
                }
                if (pFT_ClrRts == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_ClrRts.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetDTR(bool Enable)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_SetDtr.");
                }
                if (pFT_ClrDtr == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_ClrDtr.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetTimeouts(UInt32 ReadTimeout, UInt32 WriteTimeout)
        {
            ...
            else
            {
                if (pFT_SetTimeouts == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetTimeouts.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetBreak(bool Enable)
        {
            ...
            else
            {
                ...
                {
                    throw new IOException("Failed to load function FT_SetBreakOn.");
                }
                if (pFT_SetBreakOff == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetBreakOff.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetResetPipeRetryCount(UInt32 ResetPipeRetryCount)
        {
            ...
            else
            {
                if (pFT_SetResetPipeRetryCount == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetResetPipeRetryCount.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetDriverVersion(ref UInt32 DriverVersion)
        {
            ...
            else
            {
                if (pFT_GetDriverVersion == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetDriverVersion.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetLibraryVersion(ref UInt32 LibraryVersion)
        {
            ...
            else
            {
                if (pFT_GetLibraryVersion == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetLibraryVersion.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetDeadmanTimeout(UInt32 DeadmanTimeout)
        {
            ...
            else
            {
                if (pFT_SetDeadmanTimeout == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetDeadmanTimeout.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetLatency(byte Latency)
        {
            ...
            else
            {
                if (pFT_SetLatencyTimer == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetLatencyTimer.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetLatency(ref byte Latency)
        {
            ...
            else
            {
                if (pFT_GetLatencyTimer == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetLatencyTimer.");
                }
            }
            return ftStatus;
        }
        ...
        //public UInt32 InTransferSize(UInt32 InTransferSize, UInt32 OutTransferSize)
        {
            ...
            else
            {
                if (pFT_SetUSBParameters == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetUSBParameters.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS SetCharacters(byte EventChar, bool EventCharEnable, byte ErrorChar, bool ErrorCharEnable)
        {
            ...
            else
            {
                if (pFT_SetChars == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_SetChars.");
                }
            }
            return ftStatus;
        }
        ...
        public FT_STATUS GetCOMPort(out string ComPortName)
        {
            ...
            else
            {
                if (pFT_GetComPortNumber == IntPtr.Zero)
                {
                    throw new IOException("Failed to load function FT_GetComPortNumber.");
                }
            }
            return ftStatus;
        }
